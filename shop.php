            ...
            <div class="col-12">
                <div class="navTabs">
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a href="#shoppingCart" class="active" data-toggle="tab">SHOPPING CART</a>
                        </li>
                        <li class="nav-item"><a href="#wishList" data-toggle="tab">WISHLIST</a></li>
                        <li class="nav-item"><a href="#checkOut" data-toggle="tab">CHECKOUT</a></li>
                        <li class="nav-item"><a href="#orderComp" data-toggle="tab">ORDER COMPLETE</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-12">
                <div class="tab-content">
                    <!-- shopping-cart start -->
                    <div class="tab-pane active show" id="shoppingCart">
                        <form action="#">
                                                ...
                                                <td class="product-thumbnail  text-left">
                                                    ...
                                                    <div class="single-product">
                                                        <div class="product-img">
                                                            <a href="single-product.html"><img src="images/shop1.jpg"
                                                                    alt="" /></a>
                                                        </div>
                                                        <div class="product-info">
                                                            <h4 class="post-title"><a class="text-light-black"
                                                                    href="#">dummy product name</a></h4>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail  text-left">
                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-info">
                                                    <h4 class="post-title"><a class="text-light-black" href="#">dummy
                                                            product name</a></h4>
                                                    <p class="mb-0">Color : Black</p>
                                                    <p class="mb-0">Size : SL</p>
                                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mt-xs-30">
                                        <div class="billing-details pl-20">
                                            <h4 class="title-1 title-border text-uppercase mb-30">ship to different
                                                address</h4>
                                            <input type="text" placeholder="Your name here...">
                                            <input type="text" placeholder="Email address here...">
                                            <input type="text" placeholder="Phone here...">
                                    ...
                                    <div class="col-md-6">
                                        <div class="payment-method mt-60  pl-20">
                                            ...
                                            <div class="payment-accordion">
                                                ...
                                                <!-- Accordion end -->
                                                <button class="button-one submit-button mt-15" data-text="place order"
                    ...
                    <div id="orderComp" class="tab-pane fade">
                        <div class="tab-pane active show" id="order-complete" role="tabpanel">
                            <form action="#">
                                <div class="thank-recieve">
                                    <p>Thank you. Your order has been received.</p>
                                </div>
                                <div class="order-info text-center clearfix">
                                    ...
                                    <div class="single-order-info">
                                        ...
                                        <p class="text-uppercase text-light-black mb-0"><strong>june 15, 2024</strong></p>
                                    </div>
                                    <div class="single-order-info">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-xs-30">
                                            <div class="payment-method  pl-20">
                                                ...
                                                <div class="payment-accordion">
                                                    <!-- Accordion start  -->
                                                    <h3 class="payment-accordion-toggle">Direct Bank Transfer</h3>
                                                    <div class="payment-content default" style="display: none;">
                                                        <p>Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order won't be shipped until the funds have cleared in our account.</p>
                                                    </div> 
                                                    <!-- Accordion end -->
                                                    <!-- Accordion start -->
                                                    <h3 class="payment-accordion-toggle active">Cheque Payment</h3>
